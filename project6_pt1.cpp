...
int main () {
	...
	// function for the sum of the grades
...
/* 1. Function Name: openFiles
   ...
   4. Date of config: March 15, 2011*/
...
void sumGrades (int& countFemale, int& countMale, double& sumFemaleGPA, double& sumMaleGPA, ifstream& in_file)
{
	...
	// the variable for the GPA that's input
	double inputGPA;
	...
	
	{
		...
		{
			sumMaleGPA += inputGPA; // sumMaleGPA is the sum of the added input GPAs from the file
			countMale++;// counter for the male students
		}
		
		// if the character is f or F for female
		else if(gender == 'f' || gender == 'F')
		{
			sumFemaleGPA += inputGPA; // sumFemaleGPA is the sum of the added input GPAs from the file
			countFemale++; // counter for the number of females
		}
...
void averageGrade (int countFemale, int countMale, double sumFemaleGPA, double sumMaleGPA, double& male, double& female)
{
	...
	male = sumMaleGPA / countMale; // takes the sum of the male GPAs from the file and divides by the number of males
    female = sumFemaleGPA / countFemale; // takes the sum of the female GPAs from the file and divides by the # of females
}
